<?php /* Template Name: JOin our team Template */ ?>
...
<section class="career">
    <div class="container">
       <h3 class="txt">Come. Work with Us</h3>
       <p class="txt">is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
       
      <?php $count=1; $index_query = new WP_Query(array( 'post_type' => 'jobs', 'posts_per_page' => '-1' , 'order'=>'asc')); ?>
    <?php while ($index_query->have_posts()) : $index_query->the_post(); ?> 
               ...
               <div class="col-md-12">
                 <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                         <a href="#" data-toggle="modal" data-target="#job<?php echo $count; ?>" rel="<?php echo get_the_title(); ?>" class="vbtn">View and Apply</a>
                      </div>
                  </div>
               </div>
       ...
       <div class="modal fade job-popup" id="job<?php echo $count; ?>" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
