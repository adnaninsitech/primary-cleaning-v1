<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "37e37c9b895aa993a009729427d7a1e0ce37dfd526"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/primary-cleaning-v1/wp-content/themes/newcarltonsvirtualsolutions/page-template/temp-contact.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/primary-cleaning-v1/wp-content/plugins/wpide/backups/themes/newcarltonsvirtualsolutions/page-template/temp-contact_2022-02-18-22.php") )  ) ){
				...
				<div class="row box-contact__wrapper">
					...
					<div class="col-sm-6 col-md-3">
						<div class="box-contact">
							...
							<address>
								<a href="mailto:<?php echo $options['email']; ?>" class="emailclass"><?php echo $options['email']; ?></a>
							</address>
						</div>
					</div>
					<div class="col-sm-6 col-md-3">
