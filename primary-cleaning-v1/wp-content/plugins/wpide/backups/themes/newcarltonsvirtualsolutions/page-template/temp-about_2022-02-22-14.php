...
<div class="section-indent no-margin">
		<div class="box02-info lazyloaded" data-bg="images/box02-info-wrapper.png" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/box02-info-wrapper.png);">
