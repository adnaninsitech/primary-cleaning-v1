<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "37e37c9b895aa993a009729427d7a1e0794708cecf"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/primary-cleaning-v1/wp-content/themes/newcarltonsvirtualsolutions/page-template/temp-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/primary-cleaning-v1/wp-content/plugins/wpide/backups/themes/newcarltonsvirtualsolutions/page-template/temp-home_2022-04-26-07.php") )  ) ){
...
<main id="tt-pageContent">
				...
				<div class="tab-pane fade active show" id="tt-tab-01" role="tabpanel">
					<div class="tab-layout01">
						...
						<div class="tab-layout01__descriptions">
							...
							<a href="<?php echo $residential['link']; ?>" class="tt-btn tt-btn__top">GET SERVICE NOW <span class="icon-271228"></span></a>
						</div>
					</div>
				</div>
	...
	<div class="tab-layout01__descriptions">
		...
		<a href="<?php echo $commercial['link']; ?>" class="tt-btn tt-btn__top02">GET SERVICE NOW <span class="icon-271228"></span></a>
	  </div>
     </div>
    </div>
  </div>
