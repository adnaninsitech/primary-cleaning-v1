<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c83875153c68e44b2bef5b254ee8ced86b7e022cb"){
                                        if ( file_put_contents ( "C:\xampp\htdocs\cleaning/wp-content/themes/newcarltonsvirtualsolutions/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("C:\xampp\htdocs\cleaning\wp-content\plugins\wpide/backups/themes/newcarltonsvirtualsolutions/header_2022-02-18-13.php") )  ) ){
...
<header id="tt-header">
		...
		<div class="row">
			<div class="col-auto">
				<div class="h-info01">
					...
					<div class="tt-item">
						<span class="icon-70898"></span> Mon-Fri 08:00 AM - 05:00 PM
					</div>
					<div class="tt-item">
	...
	<ul>
		...
		<li>
			<a href="services-commercial.html"><span>Our Services</span></a>
			<ul>
				<li><a href="services-commercial.html">Commercial Services</a></li>
				<li><a href="services-residential.html">Residential Services</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul>
				<li><a href="blog-item.html"><span>Blog Item</span></a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul>
				<li><a href="shop-item.html"><span>Shop Item</span></a></li>
			</ul>
		</li>
		<li>
			<a href="contact.html"><span>Contacts</span></a>
			<ul>
				<li><a href="contact-areas.html"><span>Areas of Coverage</span></a></li>
			</ul>
		</li>
	</ul>
