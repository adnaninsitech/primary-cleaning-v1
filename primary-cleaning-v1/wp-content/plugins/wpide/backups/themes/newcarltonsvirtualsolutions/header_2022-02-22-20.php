		...
		<div class="tt-holder-wrapper">
			<div class="tt-holder">
				<div class="tt-col-left">
					<!-- logo -->
						<a href="<?php echo site_url(); ?>" class="tt-logo tt-logo-alignment">	<img class="" src="<?php echo $logoSrc; ?>" alt=""> </a>
					<!-- /logo -->
				</div>
...
<!--	<ul>
		...
		<li><a href="<?php echo site_url(); ?>/about-us"><span>About Us</span></a></li>
		<li>
			<a href="#"><span>Our Services</span></a>
			<ul>
				<li><a href="<?php echo site_url(); ?>/service-commercial/">Commercial Services</a></li>
				<li><a href="<?php echo site_url(); ?>/service-residential/">Residential Services</a></li>
			</ul>
		</li>
		<li><a href="<?php echo site_url(); ?>/faqs/"><span>FAQs</span></a></li>
		<li>
			<a href="<?php echo site_url(); ?>/gift-certificate/"><span>Gift Certificate</span></a>
			<ul>
				<li><a href="<?php echo site_url(); ?>/refer-earn/"><span>Referral Bonus</span></a></li>
			</ul>
		</li>
		<li><a href="<?php echo site_url(); ?>/join-our-team/"><span>Join our Team</span></a></li>
		
		<li>
			<a href="<?php echo site_url(); ?>/contact-us/"><span>Contacts</span></a>
