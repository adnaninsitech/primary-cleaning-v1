<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c83875153c68e44b2bef5b254ee8ced86b7e022cb"){
                                        if ( file_put_contents ( "C:\xampp\htdocs\cleaning/wp-content/themes/newcarltonsvirtualsolutions/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("C:\xampp\htdocs\cleaning\wp-content\plugins\wpide/backups/themes/newcarltonsvirtualsolutions/footer_2022-02-18-18.php") )  ) ){
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<nav class="f-nav" id="f-nav">
						<ul>
							...
							<li><a href="services-commercial.html"><span>Our Services</span></a></li>
				...
				<div class="col-md-4">
					...
					<address>
						...
						<p>
							<a href="tel:1(800)7654321"><span class="icon-1034182"></span> <strong> 1-800-654-3210</strong></a> (24/7 Emergency)
						</p>
					</address>
					<!--<ul class="f-social">
...
<div class="copyright">
   <div class="container">
     &copy; 2022 Primary Cleaning. All Rights Reserved. Made with love by<a href="http://insitech.ae/" class="made">&nbsp;Insitech <img src="https://insitechstaging.com/demo/primary-cleaning/wp-content/themes/custom-theme/assets/images/company.png" alt=""></a></p>
   </div>
</div>
